...
public class SingersView {

    private SingersModel singersModel;  // Экземпляр модели для взаимодействия с базой данных
    private Scanner scanner;

    public SingersView(SingersModel singersModel) {
